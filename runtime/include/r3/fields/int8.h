...
namespace r3{ namespace fields
{
	...
	public:
		Int8 &operator=(boost::int8_t from)
		{
			fvs(fvs_set);
			_value = from;
			return *this;
		}
		Int8 &operator=(boost::int16_t from)
		{
			fvs(fvs_set);
			_value = (boost::int8_t)from;
			return *this;
		}
		Int8 &operator=(boost::int32_t from)
		{
			fvs(fvs_set);
			_value = (boost::int8_t)from;
			return *this;
		}
		Int8 &operator=(boost::int64_t from)
		{
			fvs(fvs_set);
			_value = (boost::int8_t)from;
			return *this;
		...
		Int8 &operator=(EFieldValueState from)
		{
			Field::operator =(from);
			return *this;
		}
