...
namespace r3 {
	namespace model
	{
		...
		public:
			...
			template <> Category_Category1_ptr	getCategory<Category_Category1>() {
				return _category_Category1;
			}
			template <> Category_Owner_ptr	getCategory<Category_Owner>() {
				return _category_Owner;
			}
			template <> Category_HasRights_ptr	getCategory<Category_HasRights>() {
				return _category_HasRights;
			}
			template <> Category_Right_ptr	getCategory<Category_Right>() {
				return _category_Right;
			}
			template <> Category_Role_ptr	getCategory<Category_Role>() {
				return _category_Role;
			}
			template <> Category_Department_ptr	getCategory<Category_Department>() {
				return _category_Department;
			}
			template <> Category_User_ptr	getCategory<Category_User>() {
