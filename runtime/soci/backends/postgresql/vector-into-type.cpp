...
namespace // anonymous
{
	...
	//смотри в post_fetch_helper.hpp
...
void postgresql_vector_into_type_backend::resize(std::size_t sz)
{
    ...
    switch (type_)
    {
#define RST_ENTRY(i,t,n) case dt2_##n: resizevector_<SF##n>(data_, sz); break;
#include "rawSimpleTypes/list.h"
        // simple cases
//     case x_char:
...
std::size_t postgresql_vector_into_type_backend::size()
{
    ...
    switch (type_)
    {
#define RST_ENTRY(i,t,n) case dt2_##n: sz = get_vector_size<SF##n>(data_); break;
#include "rawSimpleTypes/list.h"
        // simple cases
//     case x_char:
