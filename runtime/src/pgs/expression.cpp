...
namespace pgs
{
	...
	{
		return utils::ImplAccess<Expression>(ExpressionImplPtr(new ExpressionImpl_op1(name, a, true)));
	}
	//////////////////////////////////////////////////////////////////////////
	Expression op1_post(const char *name, const Expression &a)
	{
		return utils::ImplAccess<Expression>(ExpressionImplPtr(new ExpressionImpl_op1(name, a, false)));
	}
	//////////////////////////////////////////////////////////////////////////
	Expression op2(const char *name, const Expression &a, const Expression &b)
	{
		return utils::ImplAccess<Expression>(ExpressionImplPtr(new ExpressionImpl_op2(name, a, b)));
	}
	//////////////////////////////////////////////////////////////////////////
	Expression op3(const char *name1, const char *name2, const Expression &a, const Expression &b, const Expression &c)
	{
		return utils::ImplAccess<Expression>(ExpressionImplPtr(new ExpressionImpl_op3(name1, name2, a, b, c)));
	}
	...
	Expression func(const char *name)
	{
		...
		return utils::ImplAccess<Expression>(ExpressionImplPtr(p));
	}
	...
	{
		ExpressionImpl_listPtr l1 = boost::shared_dynamic_cast<ExpressionImpl_list>(utils::ImplAccess<Expression>(v1).impl());
		if(l1)
		{
			l1->push(v2);
			return v1;
		...
		return utils::ImplAccess<Expression>(l);
	}
