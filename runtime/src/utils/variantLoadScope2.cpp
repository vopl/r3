...
{
	//////////////////////////////////////////////////////////////////////////
	VariantLoadScope2::VariantLoadScope2(
	...
	//////////////////////////////////////////////////////////////////////////
	Variant &VariantLoadScope2::getValue()
	{
		assert(!_errorWas);
	...
	//////////////////////////////////////////////////////////////////////////
	bool VariantLoadScope2::errorWas()
	{
		return _errorWas;
	}
...
// 	}
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::set_null()
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::set_string(const std::string &content)
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::set_double(const double &content)
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::set_float(const float &content)
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::set_integer(const std::string &content)
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::set_bool(bool b)
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::set_uuid(const std::string &content)
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::set_date(const SDate &d)
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::set_time(const STime &t)
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::set_datetime(const SDateTime &dt)
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::array_start()
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::array_push()
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::array_stop()
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::map_start()
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::map_key(const std::string &content)
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::map_push()
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	void VariantLoadScope2::map_stop()
	{
		if(_errorWas) return;
		assert(!_stack.empty());
	...
	//////////////////////////////////////////////////////////////////////////
	bool VariantLoadScope2::do_include(const std::string &path)
	{
