...
/*
  ...
  MaxLen: 268 435 455 Р±Р°Р№С‚ (2 147 483 647 Р±РёС‚) - РѕР±РЅР°СЂСѓР¶РµРЅРёРµ
   РѕРґРёРЅР°СЂРЅС‹С…, РґРІРѕР№РЅС‹С…, РїР°РєРµС‚РЅС‹С… Рё РІСЃРµС… РЅРµС‡РµС‚РЅС‹С… РѕС€РёР±РѕРє
*/
	...
	boost::uint32_t crc32(const void * vbuf, size_t len)
	{
