...
//////////////////////////////////////////////////////////////////////////
void Agent::onReceiveInternal(QPointer<Agent> selfKeeper, const server::TEndpoint &endpoint, utils::VariantPtr data)
{
	QString qendpoint =
	...
	emit onReceive(qdata, qendpoint);
}

//////////////////////////////////////////////////////////////////////////
void Agent::send_f(QPointer<Agent> selfKeeper, QVariant data, QString service)
{
	...
	async::Future<boost::system::error_code> ec = _agent->send(service.toUtf8().data(), pv);

	ec.wait();
	emit onSendComplete(new ErrorCode(ec), data, service);
}
...
//////////////////////////////////////////////////////////////////////////
Agent::Agent(QPointer<Session> session, client::IAgentPtr agent)
	: _session(session)
	, _agent(agent)
	, _service("echo")
{
	_agent->listen(boost::bind(&Agent::onReceiveInternal, this, QPointer<Agent>(this), _1, _2));
}
...
//////////////////////////////////////////////////////////////////////////
void Agent::send(QVariant data)
{
	return send(data, _service);
}

//////////////////////////////////////////////////////////////////////////
void Agent::send(QVariant data, QString service)
{
	async::spawn(boost::bind(
		&Agent::send_f, this, QPointer<Agent>(this), data, service));
}
