...
MIDL_DEFINE_GUID(IID, LIBID_MgaComponentLib,0xE69FC123,0x5EDB,0x4940,0xAA,0x3D,0x81,0x85,0xFC,0xF2,0x03,0xE2);


MIDL_DEFINE_GUID(CLSID, CLSID_MgaComponent,0x7B2C7F02,0x4F79,0x4697,0x9D,0xF5,0x37,0x43,0x02,0x51,0xFE,0x11);
